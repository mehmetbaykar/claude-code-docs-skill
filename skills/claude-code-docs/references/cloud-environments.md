...
| Plugins enabled only in your user settings                                                                                                                                                | No                                                               | User-scoped `enabledPlugins` lives in `~/.claude/settings.json` on your machine. Enable them for your claude.ai account instead, so Claude Code loads them as [synced plugins](https://code.claude.com/docs/en/plugins-reference#synced-plugins)                                                                                                                                                                                                                                                                                                                                                |
