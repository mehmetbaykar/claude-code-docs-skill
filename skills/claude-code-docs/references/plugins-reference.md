...
A plugin agent file uses the same [frontmatter fields as a subagent file](https://code.claude.com/docs/en/sub-agents#supported-frontmatter-fields), except that Claude Code honors only some of them when the agent comes from a plugin:
