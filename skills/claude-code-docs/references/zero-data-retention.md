...
| [Cloud sessions](https://code.claude.com/docs/en/desktop#cloud-sessions) from the Desktop app | Requires persistent session data that includes prompts and completions.                     |
| [Claude Tag](https://code.claude.com/docs/en/claude-tag)                                      | Retains channel memory and session transcripts.                                             |
