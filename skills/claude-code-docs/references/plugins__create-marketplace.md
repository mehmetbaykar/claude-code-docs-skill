...
source: https://code.claude.com/docs/en/plugins/create-marketplace
path: /docs/en/plugins/create-marketplace
---
...
* **Offering a plugin to everyone**: submit it to Anthropic's community marketplace. See [Submit to the community marketplace](https://code.claude.com/docs/en/plugins/publish#submit-to-the-community-marketplace).
