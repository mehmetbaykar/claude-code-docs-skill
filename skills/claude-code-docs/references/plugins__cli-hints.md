...
source: https://code.claude.com/docs/en/plugins/cli-hints
path: /docs/en/plugins/cli-hints
---
...
This page applies only if your plugin is listed in `claude-plugins-official` or another marketplace with one of Anthropic's [official marketplace names](https://code.claude.com/docs/en/plugins/security#official-marketplace-names). The community marketplace, `claude-community`, isn't one of them.

To publish a plugin, see [Publish and distribute a plugin](https://code.claude.com/docs/en/plugins/publish).
...
The [environment variables reference](https://code.claude.com/docs/en/env-vars) has the details.
...
* **Yes, install**: installs the plugin at [user scope](https://code.claude.com/docs/en/plugins/install)
...
* [Publish and distribute a plugin](https://code.claude.com/docs/en/plugins/publish): the routes for distributing a plugin, including the official marketplace, which the hint requires
* [Plugin commands reference](https://code.claude.com/docs/en/plugins/cli-reference#plugin-install): the shell command that installs the same plugin outside a session
