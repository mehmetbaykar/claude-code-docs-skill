...
* [Publish and distribute a plugin](https://code.claude.com/docs/en/plugins/publish): the routes into each marketplace, including the official marketplace, which the hint requires
