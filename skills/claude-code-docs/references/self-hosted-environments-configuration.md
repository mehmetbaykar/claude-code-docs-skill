...
* `interrupted`: an idle release, startup timeout, server deassign, drain, watchdog kill, or the [`released=false` backstop](https://code.claude.com/docs/en/self-hosted-environments-reference#session-lifecycle-counter-semantics).
