...
| Optional pairing or walkthroughs        | 0 to 30 minutes  | Reserve this for colleagues who are genuinely blocked, and offer the [Quickstart](https://code.claude.com/docs/en/quickstart) link before scheduling time. |
