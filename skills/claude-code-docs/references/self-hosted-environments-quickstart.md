...
path: /docs/en/self-hosted-environments-quickstart
---
...
* [Test end to end](https://code.claude.com/docs/en/self-hosted-environments-testing): a CI smoke test that dispatches a session and reads Claude's replies
