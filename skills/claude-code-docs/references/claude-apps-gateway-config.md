...
* The [cross-source lock keys](https://code.claude.com/docs/en/settings#precedence-within-the-managed-tier)
...
* It is never merged when an MDM or file-based source wins and configures a [`policyHelper`](https://code.claude.com/docs/en/settings#compute-managed-settings-with-a-policy-helper).
...
The following keys are honored when any admin source above the user-writable HKCU tier sets them, regardless of which source provides the rest of the policy. When an MDM or file-based source wins and configures a [`policyHelper`](https://code.claude.com/docs/en/settings#compute-managed-settings-with-a-policy-helper), the helper's output is the only source these checks read:
...
* [`sandbox.ripgrep`](https://code.claude.com/docs/en/settings#sandbox-settings): the `ripgrep` binary the sandbox uses
