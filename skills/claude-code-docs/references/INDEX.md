...
- `agent-sdk__skills` - [Extend agents with skills](https://code.claude.com/docs/en/agent-sdk/skills)
...
- `agent-sdk__troubleshooting` - [Troubleshoot the Agent SDK](https://code.claude.com/docs/en/agent-sdk/troubleshooting)
...
- `claude-code-on-the-web` - [Use Claude Code in the cloud](https://code.claude.com/docs/en/claude-code-on-the-web)
...
- `desktop-ios-simulator` - [Test iOS apps in the simulator](https://code.claude.com/docs/en/desktop-ios-simulator)
...
- `managed-settings` - [Deploy managed settings](https://code.claude.com/docs/en/managed-settings)
...
- `mobile` - [Claude Code on mobile](https://code.claude.com/docs/en/mobile)
...
- `plugins__anthropic-marketplaces` - [Anthropic's marketplaces](https://code.claude.com/docs/en/plugins/anthropic-marketplaces)
- `plugins__cli-hints` - [Recommend your plugin from your CLI](https://code.claude.com/docs/en/plugins/cli-hints)
- `plugins__cli-reference` - [Plugin commands reference](https://code.claude.com/docs/en/plugins/cli-reference)
- `plugins__code-intelligence` - [Code intelligence plugins](https://code.claude.com/docs/en/plugins/code-intelligence)
- `plugins__components` - [Add components to a plugin](https://code.claude.com/docs/en/plugins/components)
- `plugins__create-marketplace` - [Create a marketplace](https://code.claude.com/docs/en/plugins/create-marketplace)
- `plugins__create` - [Create a Claude Code plugin](https://code.claude.com/docs/en/plugins/create)
- `plugins__dependencies` - [Plugin dependencies](https://code.claude.com/docs/en/plugins/dependencies)
- `plugins__host-marketplace` - [Host and maintain a marketplace](https://code.claude.com/docs/en/plugins/host-marketplace)
- `plugins__install` - [Install and manage plugins](https://code.claude.com/docs/en/plugins/install)
- `plugins__loading` - [Plugin loading reference](https://code.claude.com/docs/en/plugins/loading)
- `plugins__manifest-reference` - [Plugin manifest reference](https://code.claude.com/docs/en/plugins/manifest-reference)
- `plugins__marketplace-reference` - [Marketplace reference](https://code.claude.com/docs/en/plugins/marketplace-reference)
- `plugins__measure` - [Measure plugin cost and usage](https://code.claude.com/docs/en/plugins/measure)
- `plugins__org` - [Manage Claude Code plugins for your organization](https://code.claude.com/docs/en/plugins/org)
- `plugins__overview` - [Plugins overview](https://code.claude.com/docs/en/plugins/overview)
- `plugins__publish` - [Publish and distribute a plugin](https://code.claude.com/docs/en/plugins/publish)
- `plugins__relevance` - [Recommend plugins for your org](https://code.claude.com/docs/en/plugins/relevance)
- `plugins__security` - [Plugin security and trust](https://code.claude.com/docs/en/plugins/security)
- `plugins__troubleshooting` - [Troubleshoot plugins](https://code.claude.com/docs/en/plugins/troubleshooting)
...
- `self-hosted-environments-configuration` - [Customize sessions in self-hosted environments](https://code.claude.com/docs/en/self-hosted-environments-configuration)
- `self-hosted-environments-deploy` - [Deploy self-hosted environments to production](https://code.claude.com/docs/en/self-hosted-environments-deploy)
- `self-hosted-environments-identity` - [Verify session identity in self-hosted environments](https://code.claude.com/docs/en/self-hosted-environments-identity)
- `self-hosted-environments-quickstart` - [Self-hosted environments quickstart](https://code.claude.com/docs/en/self-hosted-environments-quickstart)
- `self-hosted-environments-reference` - [Self-hosted environments reference](https://code.claude.com/docs/en/self-hosted-environments-reference)
- `self-hosted-environments-testing` - [Test self-hosted environments end to end](https://code.claude.com/docs/en/self-hosted-environments-testing)
- `self-hosted-environments` - [Self-hosted environments](https://code.claude.com/docs/en/self-hosted-environments)
...
- `settings-example` - [Example settings files](https://code.claude.com/docs/en/settings-example)
- `settings-reference` - [All settings](https://code.claude.com/docs/en/settings-reference)
- `settings` - [Settings files and precedence](https://code.claude.com/docs/en/settings)
...
- `web-quickstart` - [Get started with Claude Code in the cloud](https://code.claude.com/docs/en/web-quickstart)
...
- `whats-new__2026-w29` - [Week 29 · July 13–17, 2026](https://code.claude.com/docs/en/whats-new/2026-w29)
- `whats-new__2026-w30` - [Week 30 · July 20–24, 2026](https://code.claude.com/docs/en/whats-new/2026-w30)
- `whats-new__2026-w32` - [Week 32 · August 3–7, 2026](https://code.claude.com/docs/en/whats-new/2026-w32)
- `whats-new__2026-w33` - [Week 33 · August 10–14, 2026](https://code.claude.com/docs/en/whats-new/2026-w33)
- `whats-new__2026-w34` - [Week 34 · August 17–21, 2026](https://code.claude.com/docs/en/whats-new/2026-w34)
- `whats-new__2026-w35` - [Week 35 · August 24–28, 2026](https://code.claude.com/docs/en/whats-new/2026-w35)
- `whats-new__2026-w36` - [Week 36 · August 31 – September 4, 2026](https://code.claude.com/docs/en/whats-new/2026-w36)
- `whats-new__2026-w37` - [Week 37 · September 7–11, 2026](https://code.claude.com/docs/en/whats-new/2026-w37)
