...
In an interactive sending session, the notice appears in the transcript. A [`claude -p`](https://code.claude.com/docs/en/headless) sender receives it in [streamed output](https://code.claude.com/docs/en/headless#stream-responses) as an [informational `system` message](https://code.claude.com/docs/en/agent-sdk/typescript#sdkinformationalmessage). Notices to `claude -p` senders require Claude Code v2.1.271 or later.
