...
* **Your cloud sessions**: your [Claude Code on the web](https://code.claude.com/docs/en/claude-code-on-the-web) sessions, shown while this session is connected to [Remote Control](https://code.claude.com/docs/en/remote-control).
* **Your Remote Control sessions on other machines**: shown while this session is connected to [Remote Control](https://code.claude.com/docs/en/remote-control), and labeled `Remote Control`.
