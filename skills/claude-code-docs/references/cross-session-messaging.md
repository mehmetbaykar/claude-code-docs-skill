...
* **Your [cloud sessions](https://code.claude.com/docs/en/claude-code-on-the-web)**: shown while this session is connected to [Remote Control](https://code.claude.com/docs/en/remote-control). Claude Code labels them `cloud` in the listing.
