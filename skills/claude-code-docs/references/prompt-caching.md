...
[Skills](https://code.claude.com/docs/en/skills) and [commands](https://code.claude.com/docs/en/commands) inject their instructions as user messages at the point of invocation. Nothing earlier in the conversation changes.
