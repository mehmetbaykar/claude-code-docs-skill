...
| Do interactive development or run one-off tasks from a terminal                                  | [**Claude Code CLI**](https://code.claude.com/docs/en/overview)                                               | The terminal interface, built for daily interactive use.                                                                                                                                                                                                                                                                                                                                      |
