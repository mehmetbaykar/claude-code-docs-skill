...
* Skills marked [`disable-model-invocation: true`](https://code.claude.com/docs/en/skills#frontmatter-reference), including the bundled `/verify` and `/code-review` skills.
