...
* You are signed in to a [Claude apps gateway](https://code.claude.com/docs/en/claude-apps-gateway), or a managed settings file, MDM profile, or policy helper on your machine requires gateway sign-in with [`forceLoginMethod: "gateway"`](https://code.claude.com/docs/en/settings-reference#forceloginmethod), even before you sign in
