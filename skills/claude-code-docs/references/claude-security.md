...
The command opens the plugin's details, where you choose an [installation scope](https://code.claude.com/docs/en/discover-plugins#install-plugins) to start the install.
...
Check the install summary. If it reports `Run /reload-plugins to activate.`, see [Apply plugin changes without restarting](https://code.claude.com/docs/en/discover-plugins#apply-plugin-changes-without-restarting) to activate the plugin in your current session.
