...
Fable 5.1 requires Claude Code v2.1.255 or later and Fable 5 requires v2.1.170 or later, plus [Fable access](https://code.claude.com/docs/en/model-config#work-with-fable).
