...
Fable 5.1 requires Claude Code v2.1.257 or later, and Fable 5 requires v2.1.170 or later. Both require [Fable access](https://code.claude.com/docs/en/model-config#work-with-fable).
