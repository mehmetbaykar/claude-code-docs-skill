...
| `allowManagedHooksOnly`                        | When `true`, restricts which hooks run, and Claude Code also narrows [`statusLine`](https://code.claude.com/docs/en/statusline), `fileSuggestion`, and `subagentStatusLine` to managed settings. See [Hook configuration](https://code.claude.com/docs/en/settings#hook-configuration)                                                                                          |
