...
| `allowManagedHooksOnly`                        | When `true`, restricts which hooks run; see [Hook configuration](https://code.claude.com/docs/en/settings#hook-configuration) for the full effect list                                                                                                                                                                                                        |
...
| `disableCommandPluginSources`                  | When `true`, blocks [`command` plugin sources](https://code.claude.com/docs/en/plugin-marketplaces#command-sources) entirely, so the marketplace-declared command never runs. When unset, follows `allowManagedHooksOnly`. Requires Claude Code v2.1.229 or later                                                                                             |
