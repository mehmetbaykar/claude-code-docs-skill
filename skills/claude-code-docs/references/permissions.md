...
When a tool opens an approved file, Claude Code [confirms the path still resolves to the location the permission check approved](https://code.claude.com/docs/en/errors#refusing-after-a-symlink-changed).
