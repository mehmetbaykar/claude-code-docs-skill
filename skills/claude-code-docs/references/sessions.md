...
| Change the 30-day retention                                                     | [`cleanupPeriodDays`](https://code.claude.com/docs/en/settings#available-settings) | `settings.json`           |
