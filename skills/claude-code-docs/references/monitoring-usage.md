...
In an interactive session in a folder you haven't [trusted](https://code.claude.com/docs/en/permissions#what-runs-before-you-trust-a-folder), Claude Code doesn't export the refusal event, because project and local settings could point the export at a different collector before trust.
