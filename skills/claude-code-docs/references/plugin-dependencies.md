...
To roll bundles out across an organization, add the bundle plugin to `enabledPlugins` in [managed settings](https://code.claude.com/docs/en/settings#enabledplugins).
