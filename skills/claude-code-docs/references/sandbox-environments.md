...
When you pass `--dangerously-skip-permissions`, Claude acts without asking you first. The [actions no mode auto-approves](https://code.claude.com/docs/en/permission-modes#actions-no-mode-auto-approves) still apply.
