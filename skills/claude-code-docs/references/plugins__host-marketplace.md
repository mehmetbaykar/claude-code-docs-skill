...
source: https://code.claude.com/docs/en/plugins/host-marketplace
path: /docs/en/plugins/host-marketplace
---
...
* **Plugin sources**: each plugin source must be of type `github`, `url`, or `git-subdir`, or a [relative path](https://code.claude.com/docs/en/plugins/marketplace-reference#relative-path-plugin-source) that starts with `./`
