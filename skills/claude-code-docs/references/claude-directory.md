...
| `skills/.trash/`, `plugins/.trash/`                                                                                             | [Skills](https://code.claude.com/docs/en/skills#how-synced-skills-behave) and [plugins](https://code.claude.com/docs/en/plugins-reference#synced-plugins) synced from claude.ai that Claude Code removed. Moved here instead of deleted so you can recover the files                                                                                         |
