...
Agents shipped in a [plugin](https://code.claude.com/docs/en/plugins-reference#plugin-agent-frontmatter) honor a subset of the subagent fields.
...
| `skills/.trash/`, `plugins/.trash/`                                                                                             | [Skills](https://code.claude.com/docs/en/skills#how-synced-skills-behave) and [plugins](https://code.claude.com/docs/en/plugins-reference#synced-plugins) that the claude.ai sync removed, such as after you turn one off on claude.ai or stop syncing. The files stay here so you can recover them until the sweep deletes them                                                                |
...
| `~/.claude/skills/.trash/`, `~/.claude/plugins/.trash/`                                                              | The chance to recover [synced skills](https://code.claude.com/docs/en/skills#how-synced-skills-behave) and [synced plugins](https://code.claude.com/docs/en/plugins-reference#synced-plugins) that Claude Code removed |
