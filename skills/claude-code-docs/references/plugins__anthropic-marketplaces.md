---
title: "Anthropic's marketplaces"
source: https://code.claude.com/docs/en/plugins/anthropic-marketplaces
path: /docs/en/plugins/anthropic-marketplaces
---
...
If you wrote a plugin and want other people to install it, see [Publish a plugin](https://code.claude.com/docs/en/plugins/publish), which covers your own marketplace and submitting to the community marketplace.
