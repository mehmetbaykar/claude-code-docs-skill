...
The subagents the workflow spawns always run in `acceptEdits` mode and inherit your [tool allowlist](https://code.claude.com/docs/en/settings-reference#permission-settings), regardless of your session's permission mode. File edits are auto-approved.
